...
![](p8105_hw3_zl3386_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->

- In general, the proportion of `Excellent` responses in most states has
  not shown a significant increasing or decreasing trend over the years.
...
![](p8105_hw3_zl3386_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->

- Compared to 2006, there has been a significant increase in the
  proportion of `Very good` responses among locations in NY State in
  2010.
...
| education      | sex    |   n |
|:---------------|:-------|----:|
| \< high school | female |  28 |
| \< high school | male   |  27 |
| high school    | female |  23 |
| high school    | male   |  35 |
| \> high school | female |  59 |
| \> high school | male   |  56 |
...
![](p8105_hw3_zl3386_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->

- From the table, we can see that the participants’ sex ratio are mostly
  balanced in each education category, although in the high school
  equivalent education category there are more male participants than
  female (35:23). The more than high school education category contains
  most participants (56 male, 59 female).

- From the boxplot, we can see that participants with more than high
  school education is significantly younger than the other two education
  categories. In the high school equivalent education category, female
  participants are younger than than male participants, while in the
...
![](p8105_hw3_zl3386_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->

- In general, the amount of activity over a day goes down with the
  increase of age, and this trend is most significant in the less than
  high school education category. In high school equivalent and more
  than high school education categories, female participants tend to
  have more activity than male, while in less than high school category
...
![](p8105_hw3_zl3386_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->

- From the plot, we can see that in general, the activity level
  increases from a low level in the morning (6 ~ 12 h), remains stable
  in the afternoon and evening (12 ~ 21), and goes back to low level at
  night (21 ~ 6 h next day).
